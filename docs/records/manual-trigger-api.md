...
当前已经覆盖：RSS 入库手动触发、RSS 入库运行记录查询、Markdown 草稿手动生成、AI 摘要手动生成、AI 摘要手动归档、指定归档简报手动邮件发送、默认关闭的内部 API、默认关闭的 OpenAPI / Swagger UI、基础错误响应。
